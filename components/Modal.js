...
export default function Modal( { openModal } ) {
    ...
    if( open ) {
        return (
            ...
            <div className="flex overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 sm:h-full bg-black bg-opacity-40" id="popup-modal">
                <div className="absolute px-4 w-full max-w-md h-full md:h-auto">
                    {/* <!-- Modal content --> */}
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="p-6 pt-0 text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Para criar um post é obrigatório ter um Título e conteúdo para o Post.</h3>
